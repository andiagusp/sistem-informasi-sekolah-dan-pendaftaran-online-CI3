                ...
                <div class="p-5">
                  ...
                  <form class="user" action="<?= base_url('login'); ?>" method="post">
                    <div class="form-group">
                      ...
                      <input type="username" class="form-control form-control-user" name="username" id="username" placeholder="NIS anda" value="<?= set_value('username'); ?>">
                    ...
                    <a href="<?= base_url('home/login_cpdb'); ?>" class="btn btn-primary btn-user btn-block">Anda Calon Murid</a>
