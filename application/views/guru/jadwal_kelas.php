              ...
              <div class="form-group row">
                <div class="dropdown ml-3">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="<?= base_url('guru/jadwal_guru'); ?>">Jadwal Hari Ini</a>
                    <?php foreach($kelas as $kls): ?>
                      
                      <a class="dropdown-item" href="<?= base_url('guru/jadwal_kelas'); ?>/<?= $kls['id_kelas']; ?>"><?= $kls['kelas']; ?></a>
                    <?php endforeach; ?>
                  </div>
                </div>
                ...
                <div class="dropdown ml-1">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="<?= base_url('guru/jadwal_hari'); ?>/<?= $h; ?>"><?= cek_h($h); ?></a>
                    <?php endforeach; ?>
                  </div>
                </div>  
              </div>
                ...
                <?php if(empty($jadwal)): ?>
                  <div class="alert alert-danger">Tidak Ada Jadwal Hari Ini</div>
                <?php endif; ?>
  						</div>
  					</div>
  				</div>
